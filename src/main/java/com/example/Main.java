  ...
  public static void main(String[] args) {
    ...
    do {
      System.out.println(
          "\n***************************************************************");
      System.out.println(
          "Welcome to " + hotelName + ". Chose one of the following options:");
      ...
      switch (choice) {
        case '1':
          // read client name and room time then call createReservation to try to create
          // the reservation
          System.out.print("Please enter your name: ");
          clientName = input.nextLine();
          System.out.print(
              "What type of room would you like to reserve (double, queen, king)? ");
          roomType = input.nextLine();
          hotel.createReservation(clientName, roomType);
          break;
        case '2':
          // read client name and room time then call cancelReservation to try to cancel
          // the reservation
          System.out.print(
              "Please enter the name you used to make the reservation: ");
          clientName = input.nextLine();
          System.out.print(
              "What type of room did you reserve (double, queen, king)? ");
          roomType = input.nextLine();
          hotel.cancelReservation(clientName, roomType);
          break;
        case '3':
          // read the client name then call printInvoice to calculate and print its
          // invoice
          System.out.print("Please enter your name: ");
          clientName = input.nextLine();
